...
<body>
                ...
                <div class="header__contain">
                    ...
                    <div class="header__search">
                        <div class="header__search-input-wrap">
                            <input type="text" class="header__search-input" placeholder="Enter to search for products:" id = 'searchproduct'>s
                    ...
                    <div class="c-10 info-change">
                        ...
                        <div class="block-address">
                            ...
                            <div class="address-old">
                                <p class="address-name">Tran Thuy Nga</p>
                                <p class="address-phone">79219698056</p>
                                <p claa="address-address">Địa chỉ cụ thể xxxxx xxxx xxxx xxxxx xxxx xxxx xxxx xxxx xxxx xxxx xxxxxxx xxxxx xxxxx xxxx x.</p>
                            </div>
                            ...
                            <div class="pwd-form">
                                <ul class="pwd-list">
                                    ...
                                    <li class="pwd-list-item">
                                        ...
                                        <input type="text" class="pwd-input">
                                        <input type="button" value="Send code" class="pwd-send-code"> 
                                    </li>
                                </ul>
                                
                                <br>
                                <input type="button" value="Save" class="pwd-save-btn">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function navAddress(){
            ...
            blockPay[0].style.display="none";
            blockPwdr[0].style.display="none";
        }
